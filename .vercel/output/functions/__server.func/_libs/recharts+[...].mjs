...
var Surface = /*#__PURE__*/ (0, import_react.forwardRef)((props, ref) => {
	var children = props.children, width = props.width, height = props.height, viewBox = props.viewBox, className = props.className, style = props.style, title = props.title, desc = props.desc, others = _objectWithoutProperties$21(props, _excluded$21);
	var svgView = viewBox || {
		width,
		height,
		x: 0,
	...
	return /*#__PURE__*/ import_react.createElement("svg", _extends$23({}, svgPropertiesAndEvents(others), {
...
var _excluded$20 = ["children", "className"];
...
var Layer = /*#__PURE__*/ import_react.forwardRef((props, ref) => {
	var children = props.children, className = props.className, others = _objectWithoutProperties$20(props, _excluded$20);
	var layerClass = clsx("recharts-layer", className);
	return /*#__PURE__*/ import_react.createElement("g", _extends$22({ className: layerClass }, svgPropertiesAndEvents(others), { ref }), children);
});
//#endregion
...
var getCartesianPosition = (options) => {
	...
	if (position === "insideLeft") return _objectSpread$36({
		x: middleX + horizontalOffset,
		y: y + height / 2,
		horizontalAnchor: horizontalStart,
		verticalAnchor: "middle"
	}, sizeAttrs);
	if (position === "insideRight") return _objectSpread$36({
		x: middleX + midHeightWidth - horizontalOffset,
		y: y + height / 2,
		horizontalAnchor: horizontalEnd,
		verticalAnchor: "middle"
	}, sizeAttrs);
	if (position === "insideTop") return _objectSpread$36({
		x: upperX + upperWidth / 2,
		y: y + verticalOffset,
		horizontalAnchor: "middle",
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideBottom") return _objectSpread$36({
		x: lowerX + lowerWidth / 2,
		y: y + height - verticalOffset,
		horizontalAnchor: "middle",
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (position === "insideTopLeft") return _objectSpread$36({
		x: upperX + horizontalOffset,
		y: y + verticalOffset,
		horizontalAnchor: horizontalStart,
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideTopRight") return _objectSpread$36({
		x: upperX + upperWidth - horizontalOffset,
		y: y + verticalOffset,
		horizontalAnchor: horizontalEnd,
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideBottomLeft") return _objectSpread$36({
		x: lowerX + horizontalOffset,
		y: y + height - verticalOffset,
		horizontalAnchor: horizontalStart,
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (position === "insideBottomRight") return _objectSpread$36({
		x: lowerX + lowerWidth - horizontalOffset,
		y: y + height - verticalOffset,
		horizontalAnchor: horizontalEnd,
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (!!position && typeof position === "object" && (isNumber(position.x) || isPercent(position.x)) && (isNumber(position.y) || isPercent(position.y))) return _objectSpread$36({
		x: x + getPercentValue(position.x, midHeightWidth),
		y: y + getPercentValue(position.y, height),
		horizontalAnchor: "end",
		verticalAnchor: "end"
	}, sizeAttrs);
	return _objectSpread$36({
		x: centerX,
		y: y + height / 2,
		horizontalAnchor: "middle",
		verticalAnchor: "middle"
...
var Symbols = (_ref) => {
	...
	var props = _objectSpread$35(_objectSpread$35({}, _objectWithoutProperties$19(_ref, _excluded$19)), {}, {
		type,
		size,
		sizeType
	});
	...
	*/
	...
	if (isNumber(cx) && isNumber(cy) && isNumber(size)) return /*#__PURE__*/ import_react.createElement("path", _extends$21({}, filteredProps, {
...
function Items(props) {
	...
	return payload.map((entry, i) => {
		...
		var finalLabelStyle = typeof labelStyle === "object" ? _objectSpread$33({}, labelStyle) : {};
...
var DefaultLegendContent = (outsideProps) => {
	...
	return /*#__PURE__*/ import_react.createElement("ul", {
		...
		style: finalStyle
	}, /*#__PURE__*/ import_react.createElement(Items, _extends$20({}, props, { payload })));
};
//#endregion
...
function LegendContent(props) {
	var contextPayload = props.contextPayload, otherProps = _objectWithoutProperties$17(props, _excluded$17);
	var finalPayload = getUniqPayload(contextPayload, props.payloadUniqBy, defaultUniqBy$1);
	var contentProps = _objectSpread$29(_objectSpread$29({}, otherProps), {}, { payload: finalPayload });
...
function LegendImpl(outsideProps) {
	...
	var outerStyle = portalFromProps ? wrapperStyle : _objectSpread$29(_objectSpread$29({
		position: "absolute",
	...
	var legendElement = /*#__PURE__*/ import_react.createElement("div", {
		...
		position: props.position,
		offset: props.offset
	}), shouldReportDimensions && /*#__PURE__*/ import_react.createElement(LegendSizeDispatcher, lastBoundingBox), /*#__PURE__*/ import_react.createElement(LegendContent, _extends$18({}, props, { layout }, widthOrHeight, {
		margin,
		chartWidth,
		chartHeight,
		contextPayload
