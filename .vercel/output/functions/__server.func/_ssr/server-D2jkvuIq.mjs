...
//#region node_modules/.nitro/vite/services/ssr/assets/server-D2jkvuIq.js
var server_D2jkvuIq_exports = /* @__PURE__ */ __exportAll$1({
	a: () => getRequest,
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B_DqBhoy.mjs");
...
var manifest = {
	"3e8dc7772233a14f8b0e5bb6fe383babac22c86af3a0657cf7baf54fa9ed1c70": {
		functionName: "criarAcessoPublicoFormando_createServerFn_handler",
		importer: () => import("./alunos.functions-CPxYQ3uh.mjs")
	},
	"9ce116639a964e50e38b6c4890b9f68879251b6b8a8ab255d8913d6411e3997d": {
		functionName: "buscarTurmaPublica_createServerFn_handler",
		importer: () => import("./alunos.functions-CPxYQ3uh.mjs")
	},
	"cdb9900ab9d24c2d9251c687a9cff613946f76e3495db63ce8c936313f2fc506": {
		functionName: "criarAcessoFormando_createServerFn_handler",
		importer: () => import("./alunos.functions-CPxYQ3uh.mjs")
	},
	"db6405e0134e8a8f26038eeb3c80db4b699cbd2470df97c25001196f758d48d4": {
		functionName: "realizarAdesaoPublica_createServerFn_handler",
		importer: () => import("./alunos.functions-CPxYQ3uh.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DisewPEU.mjs").then((n) => n.I).then((n) => n.t),
		import("./start-DstxWpc_.mjs"),
...
//#endregion
export { getServerFnById as a, getRequest as i, __exportAll as n, server_D2jkvuIq_exports as o, createServerFn as r, TSS_SERVER_FUNCTION as t };
