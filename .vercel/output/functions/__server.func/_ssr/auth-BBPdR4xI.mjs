...
import { i as getClienteSession, n as clearClienteSession, o as saveClienteSession, r as cpfParaEmail, t as apenasDigitos } from "./aluno-login-Bxk3uUlL.mjs";
import { t as Button } from "./button-PwNqyxv_.mjs";
import { C as Input, F as loadDemandas, d as Card, f as CardContent, h as CardTitle, m as CardHeader, p as CardDescription, w as Label } from "./router-DisewPEU.mjs";
import { t as supabase } from "./client-O-0JSjxv.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { F as GraduationCap } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/auth-BBPdR4xI.js
	...
	const submit = async (e) => {
		...
		try {
			if (mode === "formando") {
				...
				try {
					const { data: alunoDb } = await supabase.from("alunos").select("id, nome_completo, cpf, turma_id").eq("cpf", rawDigits).limit(1).maybeSingle();
					if (alunoDb) {
						saveClienteSession({
							cpf: rawDigits,
