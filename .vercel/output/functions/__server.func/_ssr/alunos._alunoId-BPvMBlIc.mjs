...
import { B as criarAcessoFormando, C as Input, E as Route$5, M as Textarea, N as brl, S as DialogTrigger, _ as DialogContent, a as AlertDialogDescription, b as DialogHeader, c as AlertDialogTitle, d as Card, f as CardContent, g as Dialog, h as CardTitle, i as AlertDialogContent, l as AppShell, m as CardHeader, n as AlertDialogAction, o as AlertDialogFooter, r as AlertDialogCancel, s as AlertDialogHeader, t as AlertDialog, u as Badge, w as Label, x as DialogTitle, y as DialogFooter } from "./router-DisewPEU.mjs";
import { t as supabase } from "./client-O-0JSjxv.mjs";
import { i as useQueryClient, n as useQuery, t as useMutation } from "../_libs/tanstack__react-query.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { B as Eye, C as Plus, D as Package, F as GraduationCap, G as CreditCard, N as KeyRound, R as FileText, V as ExternalLink, X as CircleCheck, Z as CircleAlert, _ as Save, a as UserX, f as Trash2, i as User, it as Camera, p as SquarePen, pt as ArrowLeft, z as FileDown } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/alunos._alunoId-BPvMBlIc.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var contratoSchema = object({
	pacote: string().trim().min(2, "Informe o pacote").max(120),
	valor_total: number().positive("Valor total deve ser maior que zero"),
	desconto: number().min(0).default(0),
	valor_entrada: number().min(0).default(0),
	num_parcelas: number().int().min(1, "Mínimo 1 parcela").max(60),
	dia_vencimento: number().int().min(1).max(31),
	primeiro_vencimento: string().min(10, "Data inválida"),
	forma_pagamento: string().default("boleto")
});
var SELPICS_URL = "https://sso.youfocus.com.br/login?app_id=NDVlNGNjMjEtMTE4NC0xMWYxLThiZGYtM2EzZTUwN2Q2MDlh";
...
function AlunoDetalhe() {
	...
	const [openInativarAluno, setOpenInativarAluno] = (0, import_react.useState)(false);
	const [motivoInativacao, setMotivoInativacao] = (0, import_react.useState)("");
	...
	const [showSel1, setShowSel1] = (0, import_react.useState)(false);
	const [showSel2, setShowSel2] = (0, import_react.useState)(false);
	const [showSel3, setShowSel3] = (0, import_react.useState)(false);
	const [textoContrato, setTextoContrato] = (0, import_react.useState)(CLAUSULAS_PADRAO);
	const criarAcesso = useServerFn(criarAcessoFormando);
	const { data } = useQuery({
		queryKey: ["aluno", alunoId],
		queryFn: async () => {
			const aluno = await supabase.from("alunos").select("*, turmas(id, nome, curso, faculdade, semestre)").eq("id", alunoId).maybeSingle();
	...
	(0, import_react.useEffect)(() => {
		if (contrato?.texto_contrato) setTextoContrato(contrato.texto_contrato);
	...
	const updateLinksAluno = useMutation({
		mutationFn: async (data) => {
			...
			} else if (data.prazo_fotos_selecionadas === null) updatePayload.vencimento_fotos_selecionadas = null;
			const { error } = await supabase.from("alunos").update(updatePayload).eq("id", alunoId);
			if (error) throw error;
		},
		onSuccess: () => {
	...
	const inativarAluno = useMutation({
		...
		onError: (error) => toast.error(`Erro ao inativar cliente: ${error.message}`)
	});
	...
	const salvarContratoTexto = useMutation({
		mutationFn: async () => {
			if (!contrato) return;
			const { error } = await supabase.from("contratos").update({ texto_contrato: textoContrato }).eq("id", contrato.id);
			if (error) throw error;
		},
		onSuccess: () => {
		...
		onError: (error) => toast.error(`Erro ao salvar contrato: ${error.message}`)
	});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppShell, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				}), aluno?.status === "inativo" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
					variant: "destructive",
				...
				children: [
					...
					aluno?.status === "inativo" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
						variant: "outline",
						size: "sm",
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserX, { className: "size-4" }), " Reativar Cadastro"]
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
						variant: "outline",
						size: "sm",
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserX, { className: "size-4" }), " Inativar Cliente"]
					}),
		...
		aluno?.status === "inativo" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
			className: "mb-6 shadow-card border-amber-500/40 bg-amber-500/5",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
				className: "pt-6 text-sm text-foreground flex items-start gap-3",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "size-5 text-amber-600 shrink-0 mt-0.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
					className: "text-amber-700 dark:text-amber-500 block mb-1",
					children: "Cadastro Inativo"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "text-muted-foreground text-xs",
					children: ["Este formando foi inativado.", aluno.motivo_inativacao ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [" Motivo registrado: ", /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
		...
		aluno && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mb-6 grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 items-start",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardTitle, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(User, { className: "size-4 text-gold shrink-0" }), "Dados do Formando"]
						...
						children: [
							...
							aluno.data_nascimento && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Info, {
								label: "Data Nasc.",
								value: (/* @__PURE__ */ new Date(aluno.data_nascimento + "T12:00:00")).toLocaleDateString("pt-BR")
							})
						]
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
					className: "shadow-card",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
						className: "flex flex-row items-center gap-2 p-4 pb-3 flex-wrap",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardTitle, {
								className: "text-sm font-semibold flex items-center gap-1.5 shrink-0",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GraduationCap, { className: "size-4 text-gold shrink-0" }), "Dados da Turma"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
								variant: "secondary",
								className: "text-[11px] py-0 px-1.5 ml-auto",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
						...
						children: contrato ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
							...
							children: "Nenhum pacote contratado no momento."
						})
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
						...
						children: contrato ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "text-muted-foreground text-xs",
							children: ["Documento de ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Dialog, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTrigger, {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eye, { className: "size-3.5" }), " Ver / Editar"]
								})
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
								className: "max-w-2xl max-h-[85vh] flex flex-col",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, { children: "Contrato" }) }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex-1 overflow-y-auto space-y-4 pr-1 text-sm mt-2",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex items-center justify-between",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
												htmlFor: "texto-contrato-page",
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileDown, { className: "size-3.5" }), " Baixar PDF"]
							})]
						})] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-muted-foreground text-xs py-2",
							children: "Nenhum contrato gerado ainda."
						})
					})]
				})
			]
		...
		aluno && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mb-6 grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 items-start",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardTitle, {
							className: "text-sm font-semibold flex items-center gap-1.5 shrink-0",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Camera, { className: "size-4 text-gold shrink-0" }), "SELEÇÃO"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							variant: !showSel1 ? "default" : "secondary",
							size: "sm",
							className: "h-7 text-xs px-2.5 rounded-md ml-auto",
							onClick: () => setShowSel1(!showSel1),
							children: showSel1 ? "Ocultar" : "Visualizar"
						})]
					}), showSel1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
						className: "p-4 pt-0 text-xs text-muted-foreground border-t border-border/40 mt-1 pt-2.5 flex-1 flex flex-col",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mb-3",
							children: "Plataforma YouFocus. O Formando acessa com o mesmo CPF."
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							asChild: true,
							variant: "secondary",
							size: "sm",
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
								...
								children: ["Acessar Link ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, { className: "size-3.5 ml-1" })]
							})
						})]
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardTitle, {
							className: "text-sm font-semibold flex items-center gap-1.5 shrink-0",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "size-4 text-gold shrink-0" }), "MINHAS FOTOS SELECIONADAS"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							variant: !showSel2 ? "default" : "secondary",
							size: "sm",
							className: "h-7 text-xs px-2.5 rounded-md ml-auto",
							onClick: () => setShowSel2(!showSel2),
							children: showSel2 ? "Ocultar" : "Visualizar"
						})]
					}), showSel2 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, {
						className: "p-4 pt-0 border-t border-border/40 mt-1 pt-2.5 flex-1",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
							className: "space-y-3 flex flex-col h-full",
							onSubmit: (e) => {
								e.preventDefault();
								const form = new FormData(e.currentTarget);
								const prazoStr = form.get("prazo_fotos_selecionadas");
								updateLinksAluno.mutate({
									link_fotos_selecionadas: form.get("link_fotos_selecionadas") || null,
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
										className: "text-xs",
										children: "Prazo de Vencimento (Dias)"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex items-center space-x-2 pt-1 pb-1",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Switch, {
										id: "fotos_liberadas",
										name: "fotos_liberadas",
										defaultChecked: aluno.fotos_liberadas || false
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
										htmlFor: "fotos_liberadas",
										className: "text-xs font-medium cursor-pointer",
										children: "Liberar visualização"
									})]
								}),
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									...
									disabled: updateLinksAluno.isPending,
									children: updateLinksAluno.isPending ? "Salvando..." : "Salvar Configurações"
								})
							]
						})
					})]
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardTitle, {
							className: "text-sm font-semibold flex items-center gap-1.5 shrink-0",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileText, { className: "size-4 text-gold shrink-0" }), "APROVAÇÃO DE ÁLBUM"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							variant: !showSel3 ? "default" : "secondary",
							size: "sm",
							className: "h-7 text-xs px-2.5 rounded-md ml-auto",
							onClick: () => setShowSel3(!showSel3),
							children: showSel3 ? "Ocultar" : "Visualizar"
						})]
					}), showSel3 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, {
						className: "p-4 pt-0 border-t border-border/40 mt-1 pt-2.5 flex-1",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
							...
							onSubmit: (e) => {
								...
								const form = new FormData(e.currentTarget);
								updateLinksAluno.mutate({
									link_aprovacao_album: form.get("link_aprovacao_album") || null,
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									...
									disabled: updateLinksAluno.isPending,
									children: updateLinksAluno.isPending ? "Salvando..." : "Salvar Aprovação"
								})
							]
						})
					})]
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTrigger, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
						variant: "outline",
						size: "sm",
						className: "h-7 text-xs px-2.5 rounded-md gap-1.5",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "size-3.5" }), " Criar contrato & pacote"]
					})
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
					className: "max-w-xl",
					children: [
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
					...
					className: "h-7 text-xs px-2.5 rounded-md gap-1.5",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SquarePen, { className: "size-3.5" }), " Editar Pacote / Contrato"]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
					variant: "outline",
					size: "sm",
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trash2, { className: "size-3.5" }), " Excluir Contrato"]
				})]
			})]
		}),
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
			open: openInativarAluno,
			onOpenChange: setOpenInativarAluno,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogTitle, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserX, { className: "size-5" }), " Inativar Cliente"]
					}) }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("strong", { children: [
									"Tem certeza que deseja inativar o cadastro de ",
									aluno?.nome_completo,
									"?"
								] }),
...
function Resumo({ titulo, valor, destaque, icon: Icon }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
		className: "shadow-card h-full flex flex-col min-w-[160px]",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardHeader, {
			className: "flex flex-row items-center gap-2 p-3 pb-2",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardTitle, {
				className: "text-[11px] font-semibold flex items-center gap-1.5 shrink-0 uppercase",
				children: [Icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: "size-3.5 text-gold shrink-0" }), titulo]
			})
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, {
			className: "p-3 pt-0 text-xs border-t border-border/40 mt-1 pt-2 flex-1 flex flex-col justify-center",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: `text-base font-semibold ${destaque ? "text-destructive" : ""}`,
				children: valor
			})
		})]
	});
