...
import { C as Input, S as DialogTrigger, _ as DialogContent, a as AlertDialogDescription, b as DialogHeader, c as AlertDialogTitle, d as Card, f as CardContent, g as Dialog, i as AlertDialogContent, l as AppShell, n as AlertDialogAction, o as AlertDialogFooter, r as AlertDialogCancel, s as AlertDialogHeader, t as AlertDialog, u as Badge, w as Label, x as DialogTitle, y as DialogFooter } from "./router-DisewPEU.mjs";
import { t as supabase } from "./client-O-0JSjxv.mjs";
import { i as useQueryClient, n as useQuery, t as useMutation } from "../_libs/tanstack__react-query.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { C as Plus, F as GraduationCap, H as EllipsisVertical, O as MapPin, ct as Building2, f as Trash2, g as Search, p as SquarePen } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/turmas.index-B-XvmcGy.js
...
function TurmasPage() {
	...
	const filteredTurmas = turmas.filter((t) => t.nome.toLowerCase().includes(searchQuery.toLowerCase()) || t.curso.toLowerCase().includes(searchQuery.toLowerCase()) || t.faculdade.toLowerCase().includes(searchQuery.toLowerCase()));
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppShell, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "size-4 text-muted-foreground" })
		...
		filteredTurmas.length === 0 && !isLoading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "text-sm text-muted-foreground",
			children: "Nenhuma turma encontrada."
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "grid gap-4 sm:grid-cols-2",
			children: filteredTurmas.map((turma) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
