...
//#region node_modules/.nitro/vite/services/ssr/assets/server-BBdIZPXp.js
var server_BBdIZPXp_exports = /* @__PURE__ */ __exportAll$1({
	a: () => getRequest,
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BqdwuYCG.mjs");
...
var manifest = {
	"3e8dc7772233a14f8b0e5bb6fe383babac22c86af3a0657cf7baf54fa9ed1c70": {
		...
		importer: () => import("./alunos.functions-CSDYRiKG.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Bk1JJVce.mjs").then((n) => n.g).then((n) => n.t),
...
//#endregion
export { getServerFnById as a, getRequest as i, __exportAll as n, server_BBdIZPXp_exports as o, createServerFn as r, TSS_SERVER_FUNCTION as t };
