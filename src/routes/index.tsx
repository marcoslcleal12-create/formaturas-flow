...
function Feature({
  ...
  return (
    ...
    >
      <div className="mb-3 flex size-14 items-center justify-center rounded-xl bg-white/10 p-2 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">
